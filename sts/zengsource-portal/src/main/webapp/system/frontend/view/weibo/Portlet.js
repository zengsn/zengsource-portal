...
Ext.define('JXP.system.frontend.view.weibo.Portlet', {
    ...
    focusEmail: function() {
    	...
    	var fieldNickname = me.down('form').getForm().findField('nickname');
    	...
    	if (arr.length == 2) {
        	...
        	if (qObj.invitation && fieldCode) {
        		fieldCode.setValue(qObj.invitation);
        		//authCode = qObj.code;
        	}
        	if (qObj.nickname && fieldNickname) {
        		fieldNickname.setValue(qObj.nickname);
        	}
    	} else {
