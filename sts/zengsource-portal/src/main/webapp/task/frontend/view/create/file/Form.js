Ext.define('JXP.task.frontend.view.create.file.Form', {
    ...
    alias: 'widget.taskcreatefileform',
    ...
    constructor: function(config) {
    	...
    	this.config = Ext.apply(config, {
            ...
            items: [{
                ...
                items: [{
                    name : 'maxFileSize',
                	xtype: 'taskfilesizespinner',
                    margins   : '0 8 0 0',
                	fieldLabel: '大小限制',
                	value     : '5 MB',
                	validator : function(value) {
                		if (parseInt(value.slice(0, -3))>5) return '文件最大为5MB';
                		else return true;
                	},
                	step: 1
                }, {
            ...
            buttons: [{
            	...
            	handler: function(btn, e) {
            		var form = btn.up('taskcreatefileform');
