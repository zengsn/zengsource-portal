...
ALTER TABLE ONLY modules
    ADD CONSTRAINT uq_md_name UNIQUE (name_);

ALTER TABLE ONLY pages
    ADD CONSTRAINT uq_pg_url UNIQUE (url_);

ALTER TABLE ONLY portlets
    ADD CONSTRAINT uq_pl_jsclass UNIQUE (jsclass_);

ALTER TABLE ONLY users
    ADD CONSTRAINT uq_username UNIQUE (username_);
    
ALTER TABLE ONLY configs
  	ADD CONSTRAINT uq_cfg_key UNIQUE (key_);
...
ALTER TABLE ONLY notes
    ADD CONSTRAINT notes_pkey PRIMARY KEY (nid_);
